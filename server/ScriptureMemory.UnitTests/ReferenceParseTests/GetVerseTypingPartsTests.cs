...
public class GetVerseTypingPartsTests
{
    ...
    {
        var result = ReferenceParser.GetVerseTypingParts("Psalms 119:2-21");
    ...
    {
        var result = ReferenceParser.GetVerseTypingParts("Psalms 119:2-21, 24");
    ...
    {
        var result = ReferenceParser.GetVerseTypingParts("1 John 4:18-19, 20");
        Assert.Equal(new List<string> { "1 John", "4", "18", "19", "20" }, result);
    }
    [Fact]
    public void GetVerseTypingParts_SingleVerse_ReturnsCorrectParts()
    {
        var result = ReferenceParser.GetVerseTypingParts("John 3:16");
    ...
    {
        var result = ReferenceParser.GetVerseTypingParts("Psalms 119:18,21,24");
