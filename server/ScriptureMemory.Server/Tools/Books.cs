...
public class Books
{
    ...
    private static readonly Dictionary<string, Book> BookNamesOfBible = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        [BookNames.FirstSamuel] = new(["1 sam"], ["1 samuel", "1 samul", "1 samuels", "i samuel", "1samuel", "isamuel"]),
        [BookNames.SecondSamuel] = new(["2 sam"], ["2 samuel", "2 samul", "2 samuels", "ii samuel", "2samuel", "iisamuel"]),
        [BookNames.FirstKings] = new(["1 kgs"], ["1 kings", "1 king", "i kings", "1kings", "ikings"]),
        [BookNames.SecondKings] = new(["2 kgs"], ["2 kings", "2 king", "ii kings", "iikings", "2kings"]),
        [BookNames.FirstChronicles] = new(["1 chr"], ["1 chronicles", "1 chronicle", "1 cronicles", "i chronicles", "i cronicles", "1chronicles"]),
        [BookNames.SecondChronicles] = new(["2 chr"], ["2 chronicles", "2 chronicle", "2 cronicles", "ii chronicles", "ii cronicles", "2chronicles"]),
        [BookNames.Ezra] = new([], ["ezra"]),
        [BookNames.Nehemiah] = new(["neh"], ["nehemiah", "neimiah", "nehimiah"]),
        [BookNames.Esther] = new([], ["esther", "ester"]),
        [BookNames.Job] = new([], ["job"]),
        ...
        [BookNames.Jonah] = new(["jon"], ["jonah", "jonas", "jona"]),
        ...
        [BookNames.SecondCorinthians] = new(["2 cor"], ["2 corinthians", "2 corinthian", "2corinthians", "2 chorinthians", "ii corinthians"]),
        ...
        [BookNames.FirstThessalonians] = new(["1 thess"], ["1 thessalonians", "1 thessalonian", "1thessalonians", "i thessalonians", "1 thessallonian"]),
        ...
        [BookNames.FirstPeter] = new(["1 pet"], ["1 peter", "1peter"]),
        [BookNames.SecondPeter] = new(["2 pet"], ["2 peter", "2peter"]),
        [BookNames.FirstJohn] = new(["1 jn"], ["1 john", "1john"]),
        [BookNames.SecondJohn] = new(["2 jn"], ["2 john", "2john"]),
        [BookNames.ThirdJohn] = new(["3 jn"], ["3 john", "3john"]),
