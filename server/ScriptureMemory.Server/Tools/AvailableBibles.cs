...
public static class AvailableBibles
{
    ...
    public static Bible[] authorizedBibles =
    {
        new Bible()
        {
            ...
            Abbreviation = "kjv", // !! IMPORTANT !! When getting from memory cache, always use Abbreviation instead of AbbreviationLocal
        ...
        new Bible()
        {
            ...
            Abbreviation = "nkjv", // !! IMPORTANT !! When getting from memory cache, always use Abbreviation instead of AbbreviationLocal
        ...
        new Bible()
        {
            ...
            Abbreviation = "niv", // !! IMPORTANT !! When getting from memory cache, always use Abbreviation instead of AbbreviationLocal
        ...
        new Bible()
        {
            ...
            Abbreviation = "nasb", // !! IMPORTANT !! When getting from memory cache, always use Abbreviation instead of AbbreviationLocal
