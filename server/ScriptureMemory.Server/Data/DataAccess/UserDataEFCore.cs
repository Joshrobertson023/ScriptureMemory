...
public class UserDataEFCore : IUserData
{
    private readonly IConfiguration _config;
    private readonly ApplicationDbContext _context;

    public UserDataEFCore(
    ...
    /// <summary>
    /// Creates a new user along with the user's preferences
    /// </summary>
    ...
    public async Task<User> CreateUser()
    {
        ...
        _context.UserPreferences.Add(newUser.Preferences);
